...
rmdir /s /q "build"
copy C:\Users\Aidanamite\Documents\RaftModding\RecieverMotionDisplay\RecieverMotionDisplay.rmod D:\Steam\steamapps\common\Raft\mods\RecieverMotionDisplay.rmod
:: Build succeeded!
EXIT